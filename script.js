var map = L.map('map').setView([38.66770018453959, -9.199852796226143], 18);
...
var estacionamentos = [
  {
    tipo: "Interior",
    coords: [
      [38.668306487026655, -9.199612661495365],
      [38.667994447475074, -9.199308655499648]
    ],
    forma: "rectangle",
    cor: "#007bff"
  },
...
estacionamentos.forEach(zona => {
  let layer;
  if (zona.forma === "rectangle") {
    layer = L.rectangle(zona.coords, {
      color: zona.cor,
      weight: 2,
      fillColor: zona.cor,
      fillOpacity: 0.3
  ...
  layer.bindPopup(`<b>Zona de Estacionamento</b><br>${zona.tipo}`);
});
